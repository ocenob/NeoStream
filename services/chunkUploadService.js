...
async function initUpload(filename, fileSize, totalChunks, userId, youtubeChannelId = null) {
  ...
  if (existingUpload) {
    ...
    existingUpload.youtubeChannelId = youtubeChannelId; // Update channel ID if changed
